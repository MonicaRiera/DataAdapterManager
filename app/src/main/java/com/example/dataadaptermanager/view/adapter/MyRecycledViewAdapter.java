...
public class MyRecycledViewAdapter extends RecyclerView.Adapter<MyRecycledViewAdapter.MyViewHolder> {
    ...
    public MyRecycledViewAdapter(Context context, List<MyListItem> objects) {
